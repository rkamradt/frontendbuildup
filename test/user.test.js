...
describe('UserAPI', function(){
  ...
  describe('role-user', function(){
    ...
    it('should fail update if not logged on' , function(){
        try {
            var sut = self.UserAPI.findUser("info@genius.com");
            sut.firstName = "Randal";
    ...
    it('should fail update if not logged on as self' , function(){
        try {
            ...
            var sut = self.UserAPI.findUser("admin@genius.com");
            sut.firstName = "Randal";
    ...
    it('should be able to delete my user account', function(){
  ...
  describe('role-admin', function(){
    ...
    it('should be able to delete an account' , function(){ // ignoring criteria for now
        self.UserAPI.logon("admin@genius.com", "admin");
        var sut = self.UserAPI.createUser("joker@genius.com", "joker", "The", "Joker");
